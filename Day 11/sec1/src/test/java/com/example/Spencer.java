...
public class Spencer {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("sec1logandreport/report1.html");
    ...
    public void test1() throws Exception
    {
        ...
        PropertyConfigurator.configure("sec1/src/main/resources/log4j2.properties");
        FileInputStream fs = new FileInputStream("/Users/artiya/Downloads/Book 8.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "sec1logandreport"+result.getName()+"png";
