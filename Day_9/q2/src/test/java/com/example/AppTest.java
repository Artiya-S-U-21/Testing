...
public class AppTest 
{
    ...
    public void bt()
    {
        ExtentSparkReporter sparkReporter=new ExtentSparkReporter("/Users/artiya/Downloads/Book 6.xlsx");
...
element3.sendKeys(tenure); // Enter the new value
    ...
    public void am(ITestResult result) throws IOException
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path="/Users/artiya/Downloads/DAY_9 2"+result.getName()+".png";
...
{
    FileInputStream fs=new FileInputStream("/Users/artiya/Downloads/Book 6.xlsx");
